...
def main():
    ...
    find_date = read_dates(filename)
    find_date2 = read_dates(filename)
    # print("test")




    print('채경원', find_tmax, read_dates(filename)[max_idx1], find_diff_max, read_dates(filename)[max_idx2])
